...
<img src="https://raw.githubusercontent.com/ayayron/logviewr/master/inst/screenshot.png" height=250 alt="Log Viewer Pane Screenshot">

### List of loggers
Here is the list of loggers you currently have in your Rstudio session

### At least level
This will filter to show only the selected level and more severe messages. The ordering, from most to least severe, is:
